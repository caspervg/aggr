...
import net.caspervg.aggr.core.bean.impl.BasicParent;
import net.caspervg.aggr.ext.GeoMeasurement;
...
import static net.caspervg.aggr.worker.write.AbstractSparqlAggrWriter.*;
