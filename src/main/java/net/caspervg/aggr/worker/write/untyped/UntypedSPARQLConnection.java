...
public class UntypedSPARQLConnection extends AbstractRepositoryConnection implements HttpClientDependent {
    ...
    public UntypedSPARQLConnection(UntypedSPARQLRepository repository, SparqlSession client) {
        this(repository, client, false); // in triple mode by default
    }

    public UntypedSPARQLConnection(UntypedSPARQLRepository repository, SparqlSession client, boolean quadMode) {
        super(repository);
        this.client = client;
