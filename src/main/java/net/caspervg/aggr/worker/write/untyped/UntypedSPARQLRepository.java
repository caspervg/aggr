        ...
        implements HttpClientDependent, SesameClientDependent
{
     ...
     */
    public UntypedSPARQLRepository(String endpointUrl) {
     ...
     */
    public UntypedSPARQLRepository(String queryEndpointUrl, String updateEndpointUrl) {
            ...
            throws RepositoryException
    {
        ...
        return new UntypedSPARQLConnection(this, createHTTPClient(), quadMode);
    }
